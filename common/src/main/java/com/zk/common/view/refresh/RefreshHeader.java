package com.zk.common.view.refresh;
...
public class RefreshHeader extends ClassicsAbstract<RefreshHeader> implements com.scwang.smart.refresh.layout.api.RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public RefreshHeader(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RefreshHeader);
        ...
        lpUpdateText.topMargin = ta.getDimensionPixelSize(R.styleable.RefreshHeader_srlTextTimeMarginTop, SmartUtil.dp2px(0));
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.RefreshHeader_srlDrawableMarginRight, SmartUtil.dp2px(20));
        lpArrow.rightMargin = lpProgress.rightMargin;

        lpArrow.width = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableArrowSize, lpArrow.width);
        lpArrow.height = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableArrowSize, lpArrow.height);
        lpProgress.width = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableProgressSize, lpProgress.width);
        lpProgress.height = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableProgressSize, lpProgress.height);

        lpArrow.width = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableSize, lpArrow.width);
        lpArrow.height = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableSize, lpArrow.height);
        lpProgress.width = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableSize, lpProgress.width);
        lpProgress.height = ta.getLayoutDimension(R.styleable.RefreshHeader_srlDrawableSize, lpProgress.height);

        mFinishDuration = ta.getInt(R.styleable.RefreshHeader_srlFinishDuration, mFinishDuration);
        mEnableLastTime = ta.getBoolean(R.styleable.RefreshHeader_srlEnableLastTime, mEnableLastTime);
        mSpinnerStyle = SpinnerStyle.values[ta.getInt(R.styleable.RefreshHeader_srlClassicsSpinnerStyle,mSpinnerStyle.ordinal)];

        if (ta.hasValue(R.styleable.RefreshHeader_srlDrawableArrow)) {
            mArrowView.setImageDrawable(ta.getDrawable(R.styleable.RefreshHeader_srlDrawableArrow));
        ...
        if (ta.hasValue(R.styleable.RefreshHeader_srlDrawableProgress)) {
            mProgressView.setImageDrawable(ta.getDrawable(R.styleable.RefreshHeader_srlDrawableProgress));
        ...
        if (ta.hasValue(R.styleable.RefreshHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.RefreshHeader_srlTextSizeTitle, SmartUtil.dp2px(16)));
//        } else {
//            mTitleText.setTextSize(16);
        }

        if (ta.hasValue(R.styleable.RefreshHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.RefreshHeader_srlTextSizeTime, SmartUtil.dp2px(12)));
//        } else {
//            mLastUpdateText.setTextSize(12);
        }

        if (ta.hasValue(R.styleable.RefreshHeader_srlPrimaryColor)) {
            super.setPrimaryColor(ta.getColor(R.styleable.RefreshHeader_srlPrimaryColor, 0));
        }
        if (ta.hasValue(R.styleable.RefreshHeader_srlAccentColor)) {
            setAccentColor(ta.getColor(R.styleable.RefreshHeader_srlAccentColor, 0));
        }

        if(ta.hasValue(R.styleable.RefreshHeader_srlTextPulling)){
            mTextPulling = ta.getString(R.styleable.RefreshHeader_srlTextPulling);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextLoading)){
            mTextLoading = ta.getString(R.styleable.RefreshHeader_srlTextLoading);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextRelease)){
            mTextRelease = ta.getString(R.styleable.RefreshHeader_srlTextRelease);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextFinish)){
            mTextFinish = ta.getString(R.styleable.RefreshHeader_srlTextFinish);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextFailed)){
            mTextFailed = ta.getString(R.styleable.RefreshHeader_srlTextFailed);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextSecondary)){
            mTextSecondary = ta.getString(R.styleable.RefreshHeader_srlTextSecondary);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextRefreshing)){
            mTextRefreshing = ta.getString(R.styleable.RefreshHeader_srlTextRefreshing);
        ...
        if(ta.hasValue(R.styleable.RefreshHeader_srlTextUpdate)){
            mTextUpdate = ta.getString(R.styleable.RefreshHeader_srlTextUpdate);
        ...
        mShared = context.getSharedPreferences("RefreshHeader", Context.MODE_PRIVATE);
    ...
    public RefreshHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public RefreshHeader setTimeFormat(DateFormat format) {
    ...
    public RefreshHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public RefreshHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public RefreshHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public RefreshHeader setTextSizeTime(float size) {
    ...
    public RefreshHeader setTextSizeTime(int unit, float size) {
    ...
    public RefreshHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
    ...
    public RefreshHeader setTextTimeMarginTopPx(int px) {

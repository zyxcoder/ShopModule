...
public class RefreshFooter extends ClassicsAbstract<RefreshFooter> implements com.scwang.smart.refresh.layout.api.RefreshFooter {
    ...
    public RefreshFooter(Context context, AttributeSet attrs) {
        ...
        View.inflate(context, R.layout.view_refresh_footer, this);

...
fun <VB : ViewBinding> BottomSheetDialogFragment.inflateBindingWithBottomSheetDialogFragmentGeneric(
    layoutInflater: LayoutInflater,
    parent: ViewGroup?,
    attachToParent: Boolean
): VB =
    withBottomSheetDialogFragmentGenericBindingClass<VB>(this) { clazz ->
        clazz.getMethod(
            "inflate",
...
private fun <VB : ViewBinding> withBottomSheetDialogFragmentGenericBindingClass(
    any: Any,
    block: (Class<VB>) -> VB
): VB {

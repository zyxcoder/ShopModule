...
//                        平台售后状态：1待平台处理; 2已拒绝; 3申请撤销; 4退货/退款中; 5退款失败; 6退款完成
                        ...
                        viewLineOne.setBackgroundResource(R.color.color_FF6600)
                        ...
                        viewLineTwo.setBackgroundResource(if (it.tmsAfterSaleState == 4 || it.tmsAfterSaleState == 5 || it.tmsAfterSaleState == 6) R.color.color_FF6600 else R.color.color_B8BDCC)
                        ...
                        viewLineThree.setBackgroundResource(if (it.tmsAfterSaleState == 6) R.color.color_FF6600 else R.color.color_B8BDCC)
                    }
